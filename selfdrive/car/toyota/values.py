...
STATIC_MSGS = [
  ...
  (0x367, ECU.CAM, (CAR.SIENNA), 0, 40, '\x00\x00\x00\x00\x00\x00\x00'),
  ...
  (0x4d3, ECU.CAM, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA, CAR.SIENNA), 0, 100, '\x1C\x00\x00\x01\x00\x00\x00\x00'),
  ...
  (0x160, ECU.DSU, (CAR.SIENNA), 1,   7, '\x00\x00\x08\x12\x01\x31\x9c\x5b'),
  ...
  (0X161, ECU.DSU, (CAR.SIENNA), 1,  7, '\x00\x1e\x00\x05\x00\x00\x8c'),
  ...
  (0x366, ECU.DSU, (CAR.SIENNA), 0,  20, '\x07\xff\x0f\x02\x00\x00'),
  (0x470, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH), 1, 100, '\x00\x00\x02\x7a'),
  (0x470, ECU.DSU, (CAR.HIGHLANDER, CAR.HIGHLANDERH, CAR.SIENNA), 1,  100, '\x00\x00\x01\x79'),
